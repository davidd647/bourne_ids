...
function updateMultiSection() {
	...
	for (i in people) {
		switch (sortBy) {
			case 0:
				$('#people_output').append('<option value="' + i + '">' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 1:
				$('#people_output').append('<option value="' + i + '">' + people[i].first + ' ' + people[i].last + '</option>');
				break;
			case 2:
				$('#people_output').append('<option value="' + i + '">' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 3:
				$('#people_output').append('<option value="' + i + '">' + people[i].phone1 + ' ' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 4:
				$('#people_output').append('<option value="' + i + '">' + people[i].phone2 + ' ' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 5:
				$('#people_output').append('<option value="' + i + '">' + people[i].address + ' ' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 6:
				$('#people_output').append('<option value="' + i + '">' + people[i].city + ' ' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 7:
				$('#people_output').append('<option value="' + i + '">' + people[i].postalCode + ' ' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 8:
				$('#people_output').append('<option value="' + i + '">' + people[i].email + ' ' + people[i].last + ', ' + people[i].first + '</option>');
				break;
			case 9:
				$('#people_output').append('<option value="' + i + '">' + people[i].website + ' ' + people[i].last + ', ' + people[i].first + '</option>');
				break;
		}
	}
}
...
$('form').submit(function (e) {
	...
	if (firstName != "" && lastName != "" && phone1 != "" && //remember - phone2 is optional!
	address != "" && city != "" && postalCode != "" && email != "" && //and the personal website is, too!
...
$('#display_selected').on('click', function (e) {
	...
	for (i = 0; i < toDisplay.length; i++) {
		...
		$('#display_individual').append('<h2>' + currentPerson.first + ' ' + currentPerson.last + '</h2>' + '<p>Primary phone: ' + currentPerson.phone1 + '</p>' + '<p>Secondary phone: ' + currentPerson.phone1 + '</p>' + '<p>Address: ' + currentPerson.address + '</p>' + '<p>City: ' + currentPerson.city + '</p>' + '<p>Postal code: ' + currentPerson.postalCode + '</p>' + '<p>Email: ' + currentPerson.email + '</p>' + '<p>Website: ' + currentPerson.website + '</p>');
